...
- For common sources (URL hash, URL search param, localStorage), use the built-in wrappers above. For anything else, pass your own `useLocaleSource` / `onLocaleChange` to `createI18nReact`.
